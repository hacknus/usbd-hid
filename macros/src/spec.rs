...
pub fn try_resolve_constant(key_name: String, path: String) -> Option<u32> {
    match (key_name.as_str(), path.as_str()) {
        ...
        ("usage_page", "POWER_DEVICE") => Some(0x84),
        ("usage_page", "BATTERY_SYSTEM") => Some(0x85),
        ...
        // UPS states
        ("usage", "PresentStatus") => Some(0x02),
        ("usage", "ChangedStatus") => Some(0x03),
        ("usage", "UPS") => Some(0x04),
        ("usage", "PowerSupply") => Some(0x05),
        ("usage", "BatterySystem") => Some(0x10),
        ("usage", "Battery") => Some(0x12),
        ("usage", "Charger") => Some(0x14),
        ("usage", "PowerConverter") => Some(0x16),
        ("usage", "OutletSystem") => Some(0x18),
        ("usage", "OutletSystemID") => Some(0x19),
        ("usage", "Input") => Some(0x1A),
        ("usage", "InputID") => Some(0x1B),
        ("usage", "Output") => Some(0x1C),
        ("usage", "OutputID") => Some(0x1D),
        ("usage", "Flow") => Some(0x1E),
        ("usage", "FlowID") => Some(0x1F),
        ("usage", "Outlet") => Some(0x20),
        ("usage", "OutletID") => Some(0x21),
        ("usage", "Gang") => Some(0x22),
        ("usage", "GangID") => Some(0x23),
        ("usage", "PowerSummary") => Some(0x24),
        ("usage", "PowerSummaryID") => Some(0x25),
        ("usage", "Voltage") => Some(0x30),
        ("usage", "Current") => Some(0x31),
        ("usage", "Frequency") => Some(0x32),
        ("usage", "ApparentPower") => Some(0x33),
        ("usage", "ActivePower") => Some(0x34),
        ("usage", "PercentLoad") => Some(0x35),
        ("usage", "Temperature") => Some(0x36),
        ("usage", "Humidity") => Some(0x37),
        ("usage", "BadCount") => Some(0x38),
        ("usage", "ConfigVoltage") => Some(0x40),
        ("usage", "ConfigCurrent") => Some(0x41),
        ("usage", "ConfigFrequency") => Some(0x42),
        ("usage", "ConfigApparentPower") => Some(0x43),
        ("usage", "ConfigActivePower") => Some(0x44),
        ("usage", "ConfigPercentLoad") => Some(0x45),
        ("usage", "ConfigTemperature") => Some(0x46),
        ("usage", "ConfigHumidity") => Some(0x47),
        ("usage", "SwitchOnControl") => Some(0x50),
        ("usage", "SwitchOffControl") => Some(0x51),
        ("usage", "ToggleControl") => Some(0x52),
        ("usage", "LowVoltageTransfer") => Some(0x53),
        ("usage", "HighVoltageTransfer") => Some(0x54),
        ("usage", "DelayBeforeReboot") => Some(0x55),
        ("usage", "DelayBeforeStartup") => Some(0x56),
        ("usage", "DelayBeforeShutdown") => Some(0x57),
        ("usage", "Test") => Some(0x58),
        ("usage", "ModuleReset") => Some(0x59),
        ("usage", "AudibleAlarmControl") => Some(0x5A),
        ("usage", "Present") => Some(0x60),
        ("usage", "Good") => Some(0x61),
        ("usage", "InternalFailure") => Some(0x62),
        ("usage", "VoltageOutOfRange") => Some(0x63),
        ("usage", "FrequencyOutOfRange") => Some(0x64),
        ("usage", "Overload") => Some(0x65),
        ("usage", "OverCharged") => Some(0x66),
        ("usage", "OverTemperature") => Some(0x67),
        ("usage", "ShutdownRequested") => Some(0x68),
        ("usage", "ShutdownImminent") => Some(0x69),
        ("usage", "SwitchOn/Off") => Some(0x6B),
        ("usage", "Switchable") => Some(0x6C),
        ("usage", "Used") => Some(0x6D),
        ("usage", "Boost") => Some(0x6E),
        ("usage", "Buck") => Some(0x6F),
        ("usage", "Initialized") => Some(0x70),
        ("usage", "Tested") => Some(0x71),
        ("usage", "AwaitingPower") => Some(0x72),
        ("usage", "CommunicationLost") => Some(0x73),
        ("usage", "Undefined") => Some(0x00),
        ("usage", "SMBBatteryMode") => Some(0x01),
        ("usage", "SMBBatteryStatus") => Some(0x02),
        ("usage", "SMBAlarmWarning") => Some(0x03),
        ("usage", "SMBChargerMode") => Some(0x04),
        ("usage", "SMBChargerStatus") => Some(0x05),
        ("usage", "SMBChargerSpecInfo") => Some(0x06),
        ("usage", "SMBSelectorState") => Some(0x07),
        ("usage", "SMBSelectorPresets") => Some(0x08),
        ("usage", "SMBSelectorInfo") => Some(0x09),
        ("usage", "Reserved") => Some(0x0A),
        ("usage", "OptionalMfgFunction1") => Some(0x0B),
        ("usage", "OptionalMfgFunction2") => Some(0x0C),
        ("usage", "OptionalMfgFunction3") => Some(0x0D),
        ("usage", "OptionalMfgFunction4") => Some(0x0E),
        ("usage", "OptionalMfgFunction5") => Some(0x0F),
        ("usage", "ConnectionToSMBus") => Some(0x10),
        ("usage", "OutputConnection") => Some(0x16),
        ("usage", "ChargerConnection") => Some(0x17),
        ("usage", "BatteryInsertion") => Some(0x18),
        ("usage", "Usenext") => Some(0x19),
        ("usage", "OKToUse") => Some(0x1A),
        ("usage", "BatterySupported") => Some(0x1B),
        ("usage", "SelectorRevision") => Some(0x1C),
        ("usage", "ChargingIndicator") => Some(0x1D),
        ("usage", "ManufacturerAccess") => Some(0x28),
        ("usage", "RemainingCapacityLimit") => Some(0x29),
        ("usage", "RemainingTimeLimit") => Some(0x2A),
        ("usage", "AtRate") => Some(0x2B),
        ("usage", "CapacityMode") => Some(0x2C),
        ("usage", "BroadcastToCharger") => Some(0x2D),
        ("usage", "PrimaryBattery") => Some(0x2E),
        ("usage", "ChargeController") => Some(0x2F),
        ("usage", "TerminateCharge") => Some(0x40),
        ("usage", "TerminateDischarge") => Some(0x41),
        ("usage", "BelowRemainingCapacityLimit") => Some(0x42),
        ("usage", "RemainingTimeLimitExpired") => Some(0x43),
        ("usage", "Charging") => Some(0x44),
        ("usage", "Discharging") => Some(0x45),
        ("usage", "FullyCharged") => Some(0x46),
        ("usage", "FullyDischarged") => Some(0x47),
        ("usage", "ConditioningFlag") => Some(0x48),
        ("usage", "AtRateOK") => Some(0x49),
        ("usage", "SMBErrorCode") => Some(0x4A),
        ("usage", "NeedReplacement") => Some(0x4B),
        ("usage", "ThermistorUnderRange") => Some(0xD4),
        ("usage", "ThermistorHot") => Some(0xD5),
        ("usage", "ThermistorCold") => Some(0xD6),
        ("usage", "ThermistorOverRange") => Some(0xD7),
        ("usage", "CurrentOutOfRange") => Some(0xD9),
        ("usage", "CurrentNotRegulated") => Some(0xDA),
        ("usage", "VoltageNotRegulated") => Some(0xDB),
        ("usage", "MasterMode") => Some(0xDC),
        ("usage", "ChargerSelectorSupport") => Some(0xF0),
        ("usage", "ChargerSpec") => Some(0xF1),
        ("usage", "Level2") => Some(0xF2),
        ("usage", "Level3") => Some(0xF3),
        (_, _) => None,
    }
}
